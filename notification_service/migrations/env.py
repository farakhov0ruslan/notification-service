...
from utils_library.DataBase.driver import DataBaseEngine
...
config.set_main_option(
    "sqlalchemy.url",
    DataBaseEngine(NotificationDB.notification.database)
    .connection_link.render_as_string(hide_password=False)
    .replace("%", "%%"),
)
...
def run_migrations_offline() -> None:
    ...
    with context.begin_transaction():
        LOGGER.error(f"{target_metadata.schema}")
